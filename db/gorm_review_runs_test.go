...
func TestGormDBMigratesReviewRunTables(t *testing.T) {
	...
	assert.True(t, database.db.Migrator().HasColumn(&PRModel{}, "merge_confidence"))
...
func TestGormDBSkipMigrationsAppliesIdempotentSchemaUpdates(t *testing.T) {
	...
	require.NoError(t, database.db.Migrator().DropColumn(&PRModel{}, "MergeConfidence"))
	...
	assert.False(t, database.db.Migrator().HasColumn(&PRModel{}, "merge_confidence"))
