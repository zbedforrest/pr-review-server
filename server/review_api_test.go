...
func TestReviewAPI_200_returns_full_payload(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 7, "abc1234deadbeef", filename, 1, 3, 2, "", false))
...
func TestReviewAPI_is_stale_when_head_moved(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 8, "aaaaaaa1111111", filename, 0, 0, 0, "", false))
...
func TestReviewAPI_pin_by_sha(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 9, "bbbbbbb2222", newName, 0, 0, 0, "", false))
...
func TestReviewAPI_format_html_returns_raw(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 11, "abc1234", filename, 0, 0, 0, "", false))
...
func TestReviewAPI_format_md_returns_attachment(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 12, "abc1234deadbeef", filename, 1, 0, 0, "", false))
...
func TestReviewAPI_findings_unavailable_when_no_sidecar(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 30, "abc1234", filename, 0, 0, 0, "", false))
...
func TestReviewAPI_200_with_in_flight_true_when_regenerating(t *testing.T) {
	...
	require.NoError(t, database.MarkPRCompleted("owner", "repo", 22, "abc1234", filename, 0, 0, 0, "", false))
